...
function Footer() {
  return (
    <div data-scroll data-scroll-section data-scroll-speed="0.1" className=' absolute w-full h-screen bg-[#004d43] p-20 flex gap-10'>
        ...
        <div className='w-1/2'>
        <h1 className='text-[4vw] gap-5 font-semibold uppercase leading-none -mb-5'>Presentations</h1>
        <div>
        <div className=' font-extralight underline flex flex-col justify-center  h-[10vw] w-[10vw]  left-[4vw] ml-[5vw] mt-[7vw]'>S:
          ...
          <a href="https://www.linkedin.com/uas/login?session_redirect=%2Fcompany%2F56403597">LinkedIn</a>
          </div>
        </div>
        </div>
    </div>
